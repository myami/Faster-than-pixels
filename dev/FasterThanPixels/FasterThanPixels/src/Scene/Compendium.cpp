...
#pragma region CompendiumContent
	...
	ci_Mines.InitCompendiumInfo(true, _SceneManager->_GameManager->G_AssetManager->GetFont("FontText"), 15, "Mines", _SceneManager->_GameManager->G_AssetManager->GetTexture("MineIcon"), "2", "0", "1", "Placeholder", _SceneManager->_GameManager->View.getCenter(),2);
	ci_Reparations.InitCompendiumInfo(false, _SceneManager->_GameManager->G_AssetManager->GetFont("FontText"), 15, "Reparations", _SceneManager->_GameManager->G_AssetManager->GetTexture("RepairIcon"), "", "", "", "Placeholder", _SceneManager->_GameManager->View.getCenter(),2);
	ci_Missiles.InitCompendiumInfo(false, _SceneManager->_GameManager->G_AssetManager->GetFont("FontText"), 15, "Missiles", _SceneManager->_GameManager->G_AssetManager->GetTexture("MissilesIcon"), "3", "", "", "Placeholder", _SceneManager->_GameManager->View.getCenter(),2);
	ci_Surcadencage.InitCompendiumInfo(false, _SceneManager->_GameManager->G_AssetManager->GetFont("FontText"), 15, "Surcadencage", _SceneManager->_GameManager->G_AssetManager->GetTexture("CadenceIcon"), "", "", "", "Placeholder", _SceneManager->_GameManager->View.getCenter(),2);
	ci_Perforation.InitCompendiumInfo(false, _SceneManager->_GameManager->G_AssetManager->GetFont("FontText"), 15, "Perforation", _SceneManager->_GameManager->G_AssetManager->GetTexture("PerforingIcon"), "", "", "", "Placeholder", _SceneManager->_GameManager->View.getCenter(),2);
