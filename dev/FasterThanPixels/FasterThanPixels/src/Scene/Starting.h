...
public:
	 ...
	 void S_Action(sf::Event event); // Input recu 2/4 quand le joueur presse sur X le gamemanager va checker si dans ActionScene il y a une action sur se input et si oui lance l'action ici 
